...
class DrawableEntity {
    private final BufferedImage entityImage; //image representation
    private final AffineTransform affineTransform;  //moves/rotates images
     ...
     */
    DrawableEntity(String imageFile) {  //takes image string as parameter
    ...
    /** Updates this DrawableEntity's translation/rotation transform
     * to match the provided coordinates and angle. */
    //updates affineTransform image

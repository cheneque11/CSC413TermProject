 ...
 * those screens is currently showing, and it
 * is also registered to listen for keyboard events.
 */
public class MainView{
    /** The different screens that can be shown. */
    //card lay out / 3 screen changes
    //controls window/screen
    public enum Screen {
...
//way to represent screens
    private final JFrame mainJFrame;    //mainJFrame is where we add keyboard listeners
    private final JPanel mainPanel;
    private final CardLayout mainPanelLayout;
    private final RunGameView runGameView;

    // TODO: Finish implementing this.
    // MainView is responsible for assigning listeners
    // to various UI components (like buttons and keyboard input).
    // However, we want to return control to GameDriver when those
    // events happen. How can we have listeners that directs
